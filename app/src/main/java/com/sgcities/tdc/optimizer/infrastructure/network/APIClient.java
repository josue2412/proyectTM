...
import com.sgcities.tdc.optimizer.domain.metadata.MetadataRepository;
import com.sgcities.tdc.optimizer.domain.vehicularcapacity.VehicularCapacity;
import com.sgcities.tdc.optimizer.domain.vehicularcapacity.VehicularCapacityRepository;
...
public class APIClient {
    ...
    public void postBusStopInBatch(final List<BusStop> busStop,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/routeBusStop");
    ...
    public void postMetadataInBatch (final List<Metadata> metadata,
        ...
        String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/updateAscDescAssignment");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void postGpsLocationInBatch(final List<GPSLocation> route,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/route");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void postBusOccupationMeta(final List<VisualOccupationMetadata> visOccMeta,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/updateBusOccAssignment");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void postBusOccupation(final List<BusOccupation> busOcc,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/busOccRecord");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void postVehicularCapMeta(final List<VehicularCapacity> VehicularCap,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/updateVehicCapAssignment");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void postVehicularCapRecord(final List<VehicularCapacityRecord> VehicularCap,
        ...
        final String requestUrl = String.format("%s%s", AssignmentsDisplay.HOST_ASSIGNMENTS_SOURCE, "/app/api/persist/vehicCapRecord");
        StringRequest stringRequest =
                new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

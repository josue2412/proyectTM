...
public class BusRouteData {
    ...
    public static BusRoute[] getBusRouteData() {
        return new BusRoute[] {
                ...
                BusRoute.builder().id(12).routeName("A").routeVia("08 (MACROBUS)").build(),
                BusRoute.builder().id(13).routeName("A").routeVia("19 (MACROBUS)").build(),
                BusRoute.builder().id(14).routeName("A").routeVia("20 (MACROBUS)").build(),
                ...
                BusRoute.builder().id(26).routeName("A").routeVia("18 (MACROBUS)").build(),
                ...
                BusRoute.builder().id(56).routeName("T02").routeVia(" (TRONCAL ARTESANOS) / 80B").build(),
                ...
                BusRoute.builder().id(73).routeName("380A").build(),
                ...
                BusRoute.builder().id(85).routeName("645").routeVia("LOMAS DEL MIRADOR").build(),
                BusRoute.builder().id(86).routeName("181A").build(),
                BusRoute.builder().id(87).routeName("AGAVES").routeVia("(BUS CHAPALA)").build(),
                BusRoute.builder().id(88).routeName("AEROPUERTO").routeVia("-GUADALAJARA").build(),
                BusRoute.builder().id(89).routeName("R1A").build(),
                BusRoute.builder().id(90).routeName("623A").routeVia("PASEO PRADOS-OLIVOS").build()
        };
    }
}
